...
void main()
{
    ...
    glm::dmat4 get_model_matrix(const glm::dvec3& position, const glm::dvec3& orientation)
    {
        ...
        return glm::translate(position)                                                                     //
               ...
               * glm::translate(glm::dvec3{0.0, -1.0, 0.0}) * glm::scale(glm::dvec3{width, height, width}); //
    }
...
void player_mesh::draw(const glm::dmat4& viewprojection, const glm::dvec3& position, const glm::dvec3& orientation) const
{
